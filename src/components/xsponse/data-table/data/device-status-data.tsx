...
const statuses = ['IN ALARM', 'NOT ALARM'];
...
const DeviceStatusData: EventLog[] = Array.from({ length: 200 }, (_, index) => ({
    ID: index + 1,
    ...
    ConnectionStatus: connectionStatus[generateRandomNumber(0, connectionStatus.length - 1)],
