...
export const PartialApproved: ColumnDef<Task>[] = [
  {
...

  {
    ...
    cell: ({ row }) => (
      <div>
        {row.getValue("ApplicationStatus") === 'partially_approved_pending' ? (
          ...
          <>
            ...
            <small className="text-default-400">
              {" "}
              ({row.original.ApplicationDuration})
            </small>
          </>
        )}
      </div>
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Link href={`/users_management/dealers/dealer-info/profile-partial-approved`}>
                <Button
                  size="xs"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                variant="soft"
              >
                <Icon icon="bxs:x-circle" className="h-4 w-4" />
              </Button>
            </TooltipTrigger>
            <TooltipContent color="secondary">
